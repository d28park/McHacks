...
public class WarningsUpdater : MonoBehaviour {
	...
	void Start () {
		GeneratorSingleton.Instance.DataFrameReady += new EventHandler<DataFrameReadyEventArgs>(MyDataFrameReady);
		GeneratorSingleton.Instance.ColorImageFrameReady +=	new EventHandler<ColorImageFrameReadyEventArgs>(MyColorImageFrameReadyEventHandler);
